...
function Dog() {
  let [dogImage, setDogImage] = useState(
    "https://flipanim.com/gif/j/t/jtQPUtMy.gif",
  );
  ...
  async function newDog() {
    try {
      ...
      setDogImage(
        "https://cdn5.vectorstock.com/i/1000x1000/69/99/no-dog-sign-vector-1516999.jpg",
      );
    }
  }
  ...
  return (
    <main className="h-screen w-screen">
      <div className="flex flex-col ">
        <div className="text-center mb-3 font-bold ">{dogBreed}</div>
