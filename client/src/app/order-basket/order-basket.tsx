    ...
    return (
            <div className=" h-screen py-8">
                <div className="container mx-auto px-4">
                    <h1 className=" md:text-2xl sm:text-sm text-white-500 font-semibold mb-4"> ORDER SUMMARY</h1>
                        ...
                        <div className="md:w-3/4">
                            <div className="bg-white rounded-lg shadow-md p-6 mb-4">
                                <table className="w-full">
                                    <thead>
                                        <tr>
                                            <th className="md:text-xl sm:text-sm text-left  text-blue-600 font-semibold"> Food Name</th>
                                            <th className="md:text-xl sm:text-sm text-left text-blue-600 font-semibold"> Price</th>
                                            <th className="md:text-xl sm:text-sm text-left text-blue-600 font-semibold ml-6"> Quantity</th>
                                            <th className="md:text-xl sm:text-sm text-left text-blue-600 font-semibold"> Total</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr key={item.id}>
                                            ...
                                            <td className="xl:text-lg text-sm py-4 text-gray-700"> {item.price.toFixed(2)}</td>
                                            <td className="py-4">
                                                <div className="flex-items-center">
                                                    <button className="md:border rounded-md md:py-2 md:px-4 md:mr-2 ml-2 text-gray-700 " onClick={() => minusQuantity(index)}>-</button>
